...
for z = 1:length(Eb_N0_dB)
    ...
    h = 1/sqrt(2)*[randn(nRx,nTx,N/nTx)*(1/K) + j*randn(nRx,nTx,N/nTx)]; %Rice
...
%%MRC - nelinearni ekvalajzer, treba dati najbolje performanse
    ...
    for m = 1:length(Eb_N0_dB)
        ...
        h = 1/sqrt(2)*[randn(nRx,N)*K + j*randn(nRx,N)]; %Rice
